        ...
        children: [
            {
                ...
                loadChildren: function () {
                    return Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./employee/employee.module */ "./src/app/employee/employee.module.ts")).then(function (m) { return m.EmployeeModule; });
                }
            }
        ]
    }
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.get = function (url, params) {
        ...
        return this.httpClient.get(url, { params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.formatErrors));
    };
...
var BASE_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverUrl;
var EmployeeService = /** @class */ (function () {
    ...
    EmployeeService.prototype.createNewUser = function (employee) {
...
var EmployeeAddComponent = /** @class */ (function () {
    function EmployeeAddComponent(formBuilder, employeeService, toastrService) {
    ...
    EmployeeAddComponent.prototype.createForm = function () {
    ...
    EmployeeAddComponent.prototype.registerUser = function () {
        var _this = this;
        if (this.employeeAddForm.value) {
            var employeeData = new _core_models_employee_model__WEBPACK_IMPORTED_MODULE_4__["Employee"](this.employeeAddForm.value);
            this.employeeService.createNewUser(employeeData).subscribe(function (data) {
                _this.createForm();
                _this.toastrService.success('Employee registerd successfully', 'Success!');
            }, function (error) {
                _this.toastrService.error('error.status ' + error.message, 'Oops! Error..');
            });
        }
    };
...
var EmployeeListComponent = /** @class */ (function () {
    ...
    EmployeeListComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.showSpinner = true;
        this.employeeService.getAllUsers().subscribe(function (data) {
            if (data.length === 0) {
                _this.hideSpinner(function () {
                    _this.noDatainDb = true;
                });
            }
            else {
                _this.hideSpinner(function () {
                    _this.employees = _this.sortByFirstName(data);
                });
            }
        }, function (error) {
            _this.hideSpinner(function () {
    ...
    EmployeeListComponent.prototype.hideSpinner = function (callBack) {
        var _this = this;
        setTimeout(function () {
    ...
    EmployeeListComponent.prototype.sortByFirstName = function (data) {
...
var ToasterMessageComponent = /** @class */ (function () {
    function ToasterMessageComponent() {
    }
    ToasterMessageComponent.prototype.ngOnInit = function () {
    };
    ...
    return ToasterMessageComponent;
}());
...
var SearchPipe = /** @class */ (function () {
    ...
    SearchPipe.prototype.transform = function (items, term) {
        ...
        var result = this.filter(items, term);
        return result.length > 0 ? result : [];
    };
    SearchPipe.prototype.filter = function (items, term) {
